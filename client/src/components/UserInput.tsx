...
const UserInput = ({ userId }: UserInputProps) => {
  ...
  return (
    <div className="w-full mx-auto bg-zinc-900 rounded-lg border border-zinc-800 transition-all duration-300 hover:border-zinc-600 hover:shadow-lg hover:shadow-zinc-900/20">
